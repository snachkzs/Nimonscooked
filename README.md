...
![Gameplay Screenshot](src/assets/readme/Gameplay.png)
...
* **💨 Dash:** Koki dapat melakukan *sprint* cepat untuk berpindah antar stasiun dengan menekan tombol **B** (Cooldown: 2 detik).
...
| **Dash** | `B` | Bergerak cepat ke depan (Sprint) |
